...
class DivideInput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope12\Headers\DivideInput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope12\Headers\DivideInput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope12\Headers\DivideInput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope12\Headers\DivideInput $header)
    {
        $this->header = $header;
        return $this;
    }
