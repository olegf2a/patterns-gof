...
class MultiplyInput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope12\Headers\MultiplyInput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope12\Headers\MultiplyInput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope12\Headers\MultiplyInput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope12\Headers\MultiplyInput $header)
    {
        $this->header = $header;
        return $this;
    }
