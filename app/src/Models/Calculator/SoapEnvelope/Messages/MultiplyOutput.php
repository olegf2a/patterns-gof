...
class MultiplyOutput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope\Headers\MultiplyOutput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope\Headers\MultiplyOutput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope\Headers\MultiplyOutput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope\Headers\MultiplyOutput $header)
    {
        $this->header = $header;
        return $this;
    }
