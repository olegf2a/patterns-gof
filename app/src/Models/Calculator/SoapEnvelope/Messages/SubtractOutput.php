...
class SubtractOutput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope\Headers\SubtractOutput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope\Headers\SubtractOutput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope\Headers\SubtractOutput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope\Headers\SubtractOutput $header)
    {
        $this->header = $header;
        return $this;
    }
