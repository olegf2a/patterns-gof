...
class DivideOutput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope\Headers\DivideOutput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope\Headers\DivideOutput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope\Headers\DivideOutput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope\Headers\DivideOutput $header)
    {
        $this->header = $header;
        return $this;
    }
