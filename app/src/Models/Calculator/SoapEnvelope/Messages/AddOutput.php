...
class AddOutput implements \GoetasWebservices\SoapServices\Metadata\Envelope\Envelope
{
    ...
    /**
     * @var \App\Models\Calculator\SoapEnvelope\Headers\AddOutput $header
     */
    private $header = null;
     ...
     * Gets as header
     *
     * @return \App\Models\Calculator\SoapEnvelope\Headers\AddOutput
     */
     ...
     * Sets a new header
     *
     * @param \App\Models\Calculator\SoapEnvelope\Headers\AddOutput $header
     * @return self
     */
    public function setHeader(\App\Models\Calculator\SoapEnvelope\Headers\AddOutput $header)
    {
        $this->header = $header;
        return $this;
    }
